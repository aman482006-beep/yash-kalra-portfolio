                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {metrics.map((metric, index) => (
                            <motion.div
                                ...
                                className="bg-card p-8 rounded-2xl shadow-lg border border-border hover:border-accent/40 group transition-all duration-300"
                            >
                                <div className="text-5xl font-bold text-card-foreground mb-2 group-hover:text-accent transition-colors">
                                    <CountUp
                                        end={metric.value}
